            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="container p-0 ">
                        <div class="row">
                            <div class="main-pic mt-3 col-12">
                                <img class="img-prd" src="./images/'.$std['image'].'" alt="#">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-3">
                    ...
                    <button type="button" class="btn btn-rounded border-dark btn-cart onclick="AddToCart()">Add to Cart
